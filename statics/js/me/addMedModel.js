...
class AddMedModel extends Component {
    constructor(props){
      super(props);
      this.state={
        Lvisible:false,
    ...
    submitMedModeListData(){
        fetch(AddMedModel_URL,{
                method: 'post',
                headers: {
                ...
                body: JSON.stringify({
                   ...
                   medicine:this.props.carryData.medname,
                   methods:[{'begin':3,'days':5,'dosage':[1,1,1,1]},{'begin':3,'days':5,'dosage':[1,1,1,1]}],
                   name:'测试3',
                   count:1,
                })
          })
          ...
          .catch((err)=>{
              ...
              console.log(this.props.carryData.medname);
              Alert.alert(
                  '提示',
                  '获取失败,点击确定重试或取消!',
                  [
