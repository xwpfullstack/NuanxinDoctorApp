    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.body}>
          <Text>订单编号： 201501261000001</Text>
          <Text>提交订单时间： {this.props.orderData.date}</Text>
          <Text>咨询内容：</Text>
          <Text>1. 已服用2小时药物是否可以减量？</Text>
          <Text>2. 服用安眠药物是否可以开车？</Text>
          <Text>3. 服用此药物时是否可与同类药物一起服用？</Text>

          <View style={styles.hr}>
          </View>
          <Text>订单状态</Text>
          <Text>{this.props.orderData.state}</Text>
        </View>
      </View>
    );
  }
